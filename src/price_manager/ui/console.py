...
class InterfazConsola:
    ...
    def _exportar_csv(self) -> None:
        ...
        try:
            ...
            print(f"✅ Exportación exitosa. Archivo CSV guardado en la raíz del proyecto.")
        except Exception as e:
    ...
    def _menu_crud_principal(self) -> None:
        while True:
            ...
            if opcion == '1':
                ...
                self._menu_crud_entidad("Tipo de Cotización", self.servicios['tipo_cotizacion'], TipoCotizacion)
            elif opcion == '5':
                break
            else:
                print("Opción inválida. Intente nuevamente.")

    def _menu_crud_entidad(self, nombre_entidad: str, servicio: Any, clase_entidad: Any) -> None:
        while True:
            print(f"\n--- {nombre_entidad} ---")
            print("1. Crear")
